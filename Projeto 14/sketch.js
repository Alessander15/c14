...
function draw() {
 background(0);
  ...
  function criarBalaoes(){

  if (World.frameCount % 200 === 0) {
   switch(select_balloon ){
    case 1:red.addImage(red_balloonImage); //chamar o balão vermelho
    break;
    case 2:blue.addImage(blue_balloonImage); // chamar o balão azul
    break;
    case 3:green.addImage(green_balloonImage); // chamar o balão verde
    break;
    case 4:pink.addImage(pink_balloonImage); // chamar o balão rosa
    break;
    default:break;
  }}
}
